  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Content */}
        <div ref={contentRef as React.RefObject<HTMLDivElement>} className="max-w-4xl mx-auto">
          <div className="cursor-target bg-linear-to-br from-slate-700/30 to-zinc-800/30 p-6 sm:p-8 md:p-12 rounded-2xl sm:rounded-3xl backdrop-blur-sm border border-white/10 shadow-2xl">
        ...
        {/* Stats */}
        <div ref={statsRef as React.RefObject<HTMLDivElement>} className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8">
          <div className="cursor-target text-center p-4 sm:p-6 bg-linear-to-br from-slate-700/20 to-zinc-800/20 rounded-xl sm:rounded-2xl backdrop-blur-sm border border-white/10 hover:border-amber-400/50 transition-all duration-300 focus-within:ring-2 focus-within:ring-amber-400">
